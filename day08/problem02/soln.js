...
async function solution(path) {
  ...
  while (diagram.circuitList.length > 1) {
    let lowestIndexOne = 0;
    let lowestIndexTwo = 0;
    ...
    diagram.boxList.forEach((boxOne, indexOne) => {
      diagram.boxList.forEach((boxTwo, indexTwo) => {
        ...
        if (lowestDistance === 0 && candidateDistance !== UNINITIALIZED && candidateDistance > 0) {
          lowestIndexOne = indexOne;
          lowestIndexTwo = indexTwo;
          lowestDistance = candidateDistance;
        } else if (candidateDistance !== UNINITIALIZED && candidateDistance < lowestDistance) {
          lowestIndexOne = indexOne;
          lowestIndexTwo = indexTwo;
          lowestDistance = candidateDistance;
        }
    ...
    console.log(diagram.boxList[lowestIndexOne], diagram.boxList[lowestIndexTwo]);
    console.table(diagram.circuitList.length);
  }
}
